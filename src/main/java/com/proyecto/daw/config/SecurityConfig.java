    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                    .requestMatchers("/contacto").permitAll()                               // Acceso público a "/"                  // Acceso público a SWAGGER
                    .requestMatchers("/contacto/todos").hasRole("ADMIN")                               // Acceso público a "/"                  // Acceso público a SWAGGER
                    .requestMatchers("/donations").hasAnyRole("ADMIN")                                // Acceso público a "/"                  // Acceso público a SWAGGER
                    .requestMatchers("/donations/**").hasAnyRole("ADMIN")                                // Acceso público a "/"                  // Acceso público a SWAGGER
                    .requestMatchers("/donations/ranking").permitAll()                                // Acceso público a "/"                  // Acceso público a SWAGGER
                    .requestMatchers("/donations/*/status").permitAll()   
                    //Faltan cosas de donations aquí.                             // Acceso público a "/"                  // Acceso público a SWAGGER
